...
public class TestService_CustomReceiveMessageExternalProxy : TestService_ReceiveMessageProxyExternal, ICustomTestService_ReceiveMessageProxy
{
    ...
    public TestService_CustomReceiveMessageExternalProxy(long serviceId, IMessageInvoker messageInvoker) : base(serviceId, messageInvoker)
    {
    }

    static IServiceProxy IServiceProxy.Create(long serviceId)
    {
        throw new NotImplementedException();
    }

    static IServiceProxy IServiceProxy.Create(long serviceId, IMessageInvoker messageInvoker)
    {
        throw new NotImplementedException();
    }
}